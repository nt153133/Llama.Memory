namespace WitchHunt
{
    ...
    public static class Utilities
    {
        ...
        private static readonly SearchValues<char> _wildcardValues =
            SearchValues.Create(Wildcards);

        private static readonly SearchValues<char> _hexValues =
            SearchValues.Create(Hexchars);
        ...
        public static byte GetMask(this ReadOnlySpan<char> tok)
        {
            ...
            bool firstIsWild  = _wildcardValues.Contains(tok[0]);
            bool secondIsWild = _wildcardValues.Contains(tok[1]);
        ...
        public static bool IsValidHex(this ReadOnlySpan<char> str)
        {
            ...
            return str.IndexOfAnyExcept(_hexValues) == -1;
        }
